...
class ProfileVC: UIViewController {
    ...
    private var profileVM = ProfileVM(facebookAuthService: FacebookAuthService(), authService: FirebaseAuthService.getInstance(), authErrorHandler: BasicAuthErrorHandler())

...
struct TargetValidator {
    ...
    let ERROR_NAME_EMPTY = NSLocalizedString("The name can't be empty", comment: "The name of the provided target is an empty string")
    let ERROR_SCORES_EMPTY = NSLocalizedString("You need to provide at least one score", comment: "No scores were provided for the target")
